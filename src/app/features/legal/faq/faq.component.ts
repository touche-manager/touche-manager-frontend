      ...
      items: [
        {
          ...
          answer: 'Para inscribirte a un torneo debes seguir estos pasos: 1) Registrarte como Atleta y completar tu perfil con tus datos personales. 2) Cargar los documentos requeridos (Apto Médico vigente). 3) Ir a la sección "Inscripciones", buscar el torneo activo y realizar el pago. Tu documentación será validada por el organizador del torneo posterior a tu inscripción.',
          open: signal(false)
        },
        {
          question: '¿Qué documentos necesito subir para poder competir?',
          answer: 'Debes presentar tu Apto Médico digitalizado (en formato PDF o imagen) que sea legible y contenga la firma y sello del profesional médico. El organizador del torneo validará este documento para habilitarte a competir en las fases de poules.',
          open: signal(false)
        },
        {
          question: '¿Puedo inscribirme si mis documentos están pendientes de validación?',
          answer: 'Sí. Puedes realizar la inscripción y el pago sin problemas aunque tus documentos estén pendientes de revisión. Sin embargo, la validación de tus documentos es un requisito obligatorio para que el organizador pueda incluirte en el sorteo de poules y puedas competir.',
          open: signal(false)
        }
      ]
    },
      ...
      items: [
        {
          ...
          answer: 'Los toques son registrados por el Árbitro asignado al asalto a través del marcador digital en tiempo real de Touché Manager. El árbitro controla el cronómetro, registra las tarjetas de amonestación (amarilla, roja y negra) y valida los toques de acuerdo con el reglamento FIE.',
          open: signal(false)
        },
        {
